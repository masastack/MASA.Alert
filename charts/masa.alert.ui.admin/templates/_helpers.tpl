...
*/}}
{{- define "masa.alert.ui.admin.name" -}}
...
*/}}
{{- define "masa.alert.ui.admin.fullname" -}}
...
*/}}
{{- define "masa.alert.ui.admin.chart" -}}
...
Common labels
*/}}
{{- define "masa.alert.ui.admin.labels" -}}
helm.sh/chart: {{ include "masa.alert.ui.admin.chart" . }}
{{ include "masa.alert.ui.admin.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "masa.alert.ui.admin.selectorLabels" -}}
...
*/}}
{{- define "masa.alert.ui.admin.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "masa.alert.ui.admin.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{- define "masa.alert.ingress.annotations" -}}
...
{{- define "masa.alert.ingress.hosts" -}}
{{- if .Values.ingress.enabled -}}
rules:
