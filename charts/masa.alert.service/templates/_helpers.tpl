...
*/}}
{{- define "masa.alert.service.name" -}}
...
*/}}
{{- define "masa.alert.service.fullname" -}}
...
*/}}
{{- define "masa.alert.service.chart" -}}
...
Common labels
*/}}
{{- define "masa.alert.service.labels" -}}
helm.sh/chart: {{ include "masa.alert.service.chart" . }}
{{ include "masa.alert.service.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "masa.alert.service.selectorLabels" -}}
...
*/}}
{{- define "masa.alert.service.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "masa.alert.service.fullname" .) .Values.serviceAccount.name }}
{{- else }}
