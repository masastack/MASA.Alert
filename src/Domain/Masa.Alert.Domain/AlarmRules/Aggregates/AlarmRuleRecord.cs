...
public class AlarmRuleRecord : FullEntity<Guid, Guid>
{
    ...
    public AlarmRuleRecord(Guid alarmRuleId, ConcurrentDictionary<string, long> aggregateResult, bool isTrigger, int consecutiveCount, DateTimeOffset excuteTime, List<RuleResultItem> ruleResultItems, Guid alarmHistoryId = default)
    {
